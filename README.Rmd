...
site_dir <- path.expand("~/Library/CloudStorage/Dropbox/Sites/jameshollway.com/content/post/manynet")
...
```{r layout-comparison, echo = FALSE, message=FALSE, eval = have_site, fig.show="hide"}
library(autograph)
library(igraph)
library(gridBase)
library(grid)

# base graphics, so written with an explicit device rather than ggsave()
png(site_figure("README-layout-comparison-1.png"),
    width = 12, height = 4, units = "in", res = 250)
