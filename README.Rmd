...
Here is the same network three times:
...
setting the colours, as that same reader sees it.

```{r cvd, message=FALSE, warning=FALSE, dpi = 300, fig.height=3, fig.width=9, fig.alt="The same network seen with normal vision and with deuteranopia, in autograph's palette and in ggraph's"}
...
The six races remain tellable apart in the middle panel,
