...
test_that("setting theme provides correct palette", {
  ...
  # These check which colours a theme holds, not the order they come in:
  # the order is chosen by cvd_sort() so that the first few colours separate
  # for colour-blind viewers, and is tested in test-functional_themes.R.
  on.exit(suppressMessages(stocnet_theme("default")), add = TRUE)
  stocnet_theme("default")
  expect_setequal(getOption("snet_cat"), c("#1B9E77","#4575b4","#d73027",
                                        "#66A61E","#E6AB02","#D95F02","#7570B3",
                                        "#A6761D","#E7298A","#666666"))
  stocnet_theme("iheid")
  expect_setequal(getOption("snet_cat"), c("#006564","#0094D8","#622550",
                                        "#268D2B","#3E2682","#820C2B",
                                        "#008F92","#006EAA","#A8086E"))
  stocnet_theme("ethz")
  expect_setequal(getOption("snet_cat"), c("#215CAF","#007894","#627313",
                                        "#8E6713","#B7352D","#A7117A","#6F6F6F"))
  stocnet_theme("uzh")
  expect_setequal(getOption("snet_cat"), c("#0028A5","#4AC9E3","#A4D233",
  ...
  expect_setequal(getOption("snet_cat"), c('#E8ECFB', '#D9CCE3', '#D1BBD7', 
